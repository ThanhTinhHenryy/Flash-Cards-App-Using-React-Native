...
/*
File api.ts này chứa các hàm gọi API để giao tiếp với server của ứng dụng Flashcard.
 Nó sử dụng fetch API để gửi request và nhận response từ API. 
 Dữ liệu người dùng (ID) được lưu bằng AsyncStorage để sử dụng trong 
 các request liên quan đến user.
*/
